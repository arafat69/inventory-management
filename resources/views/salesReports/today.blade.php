...
@section('content')
    <div class="row" id="printelement">
        <div class="col-md-10 m-auto">
            <div class="">
                <a href="{{ route('month.sales') }}" class="btn btn-outline-primary btn-sm my-2">This Month</a>
                <a href="{{ route('all.sales') }}" class="btn btn-info btn-sm my-2">List</a>
            </div>
            <h4>{{ date("d F Y") }}</h4>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{ route('todaypdf') }}" class="btn btn-outline-primary float-start ms-1"> Download PDF</a>
